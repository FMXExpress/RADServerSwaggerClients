...
void
FieldGroupObject::fromJson(char* jsonStr)
{
...
FieldGroupObject::FieldGroupObject(char* json)
{
	this->fromJson(json);
}

char*
FieldGroupObject::toJson()
{
...
std::string
FieldGroupObject::getName()
{
	return name;
}

void
FieldGroupObject::setName(std::string  name)
{
	this->name = name;
}
...
void
FieldGroupObject::setFields(std::list <FieldObject_fields> fields)
{
	this->fields = fields;
}

bool
FieldGroupObject::getCustom()
{
	return custom;
}

void
FieldGroupObject::setCustom(bool  custom)
{
	this->custom = custom;
}
