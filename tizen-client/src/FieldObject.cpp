...
void
FieldObject::fromJson(char* jsonStr)
{
...
FieldObject::FieldObject(char* json)
{
	this->fromJson(json);
}
...
void
FieldObject::setName(std::string  name)
{
	this->name = name;
}

std::list<FieldObject_fields>
FieldObject::getFields()
{
	return fields;
}

void
FieldObject::setFields(std::list <FieldObject_fields> fields)
{
	this->fields = fields;
}

bool
FieldObject::getCustom()
{
	return custom;
}

void
FieldObject::setCustom(bool  custom)
{
	this->custom = custom;
}
