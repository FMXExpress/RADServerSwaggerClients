...
void
FieldsEdgeModuleObject::__cleanup()
{
	//if(name != NULL) {
	//
	//delete name;
...
void
FieldsEdgeModuleObject::fromJson(char* jsonStr)
{
...
FieldsEdgeModuleObject::FieldsEdgeModuleObject(char* json)
{
	this->fromJson(json);
}

char*
FieldsEdgeModuleObject::toJson()
{
...
std::string
FieldsEdgeModuleObject::getName()
{
	return name;
}

void
FieldsEdgeModuleObject::setName(std::string  name)
{
	this->name = name;
}

std::list<FieldObject_fields>
FieldsEdgeModuleObject::getFields()
{
	return fields;
}

void
FieldsEdgeModuleObject::setFields(std::list <FieldObject_fields> fields)
{
	this->fields = fields;
}

bool
FieldsEdgeModuleObject::getCustom()
{
	return custom;
}

void
FieldsEdgeModuleObject::setCustom(bool  custom)
{
	this->custom = custom;
}
