...
$Manifest = @{
    ...
    Description = 'IO.Swagger - the PowerShell module for EMS API Documentation'

    RootModule = 'IO.Swagger.psm1'
    Guid = '{63777EFE-AFDE-4455-B0CB-4A90B959B947}' # Has to be static, otherwise each new build will be considered different module
