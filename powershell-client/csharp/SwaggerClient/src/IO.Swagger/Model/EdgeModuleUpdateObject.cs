...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EdgeModuleUpdateObject : Dictionary<String, string>,  IEquatable<EdgeModuleUpdateObject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeModuleUpdateObject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EdgeModuleUpdateObject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EdgeModuleUpdateObject" /> class.
        /// </summary>
        ...
        public EdgeModuleUpdateObject(string modulename = default(string), string protocol = default(string), string protocolprops = default(string)) : base()
        {
            // to ensure "modulename" is required (not null)
            if (modulename == null)
            {
                throw new InvalidDataException("modulename is a required property for EdgeModuleUpdateObject and cannot be null");
            }
            else
            {
            ...
            if (protocol == null)
            {
                throw new InvalidDataException("protocol is a required property for EdgeModuleUpdateObject and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("protocolprops is a required property for EdgeModuleUpdateObject and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EdgeModuleUpdateObject);
        }

        /// <summary>
        /// Returns true if EdgeModuleUpdateObject instances are equal
        /// </summary>
        /// <param name="input">Instance of EdgeModuleUpdateObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EdgeModuleUpdateObject input)
        {
            if (input == null)
                return false;
