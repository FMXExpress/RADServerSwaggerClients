...
module Data.FieldObject exposing (FieldObject, fieldObjectDecoder, fieldObjectEncoder)
...
fieldObjectDecoder : Decoder FieldObject
fieldObjectDecoder =
    decode FieldObject
...
fieldObjectEncoder : FieldObject -> Encode.Value
fieldObjectEncoder model =
    Encode.object
