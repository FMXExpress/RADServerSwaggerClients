...
module Data.FieldsEdgeModuleObject exposing (FieldsEdgeModuleObject, fieldsEdgeModuleObjectDecoder, fieldsEdgeModuleObjectEncoder)
...
type alias FieldsEdgeModuleObject =
    { name : String
...
fieldsEdgeModuleObjectDecoder : Decoder FieldsEdgeModuleObject
fieldsEdgeModuleObjectDecoder =
    decode FieldsEdgeModuleObject
...
fieldsEdgeModuleObjectEncoder : FieldsEdgeModuleObject -> Encode.Value
fieldsEdgeModuleObjectEncoder model =
    Encode.object
