...
func (a *VersionApiService) GetVersion(ctx context.Context, localVarOptionals *GetVersionOpts) (VersionObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VersionObject
	)
