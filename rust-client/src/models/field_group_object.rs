...
impl FieldGroupObject {
  pub fn new(name: String) -> FieldGroupObject {
    FieldGroupObject {
      name: name,
      fields: None,
      custom: None
  ...
  pub fn with_name(mut self, name: String) -> FieldGroupObject {
    self.name = name;
    self
  }
  ...
  pub fn with_fields(mut self, fields: Vec<::models::FieldObjectFields>) -> FieldGroupObject {
    self.fields = Some(fields);
    self
  }
  ...
  pub fn with_custom(mut self, custom: bool) -> FieldGroupObject {
    self.custom = Some(custom);
    self
  }
