...
module SwaggerClient
  class InstallationObject
    ...
    def valid?
      ...
      device_type_validator = EnumAttributeValidator.new('String', ['ios', 'android'])
    ...
    def device_type=(device_type)
      validator = EnumAttributeValidator.new('String', ['ios', 'android'])
    ...
    def hash
      [_id, device_token, device_type, _meta, channels].hash
    end
