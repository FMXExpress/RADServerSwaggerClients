...
namespace IO.Swagger.Api
{
    ...
    public class VersionApi : IVersionApi
    {
        ...
        /// <param name="xEmbarcaderoMasterSecret"></param> 
        /// <returns>VersionObject</returns>            
        public VersionObject GetVersion (string xEmbarcaderoApplicationId, string xEmbarcaderoAppSecret, string xEmbarcaderoMasterSecret)
        {
 ...
 if (xEmbarcaderoMasterSecret != null) headerParams.Add("X-Embarcadero-Master-Secret", ApiClient.ParameterToString(xEmbarcaderoMasterSecret)); // header parameter
            ...
            return (VersionObject) ApiClient.Deserialize(response.Content, typeof(VersionObject), response.Headers);
        }
