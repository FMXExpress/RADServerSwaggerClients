...
module EMSAPIDocumentation.Client where
...
dispatchLbs
  ...
  -> EMSAPIDocumentationConfig -- ^ config
  -> EMSAPIDocumentationRequest req contentType res accept -- ^ request
