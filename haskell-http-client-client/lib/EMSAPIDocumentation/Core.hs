...
module EMSAPIDocumentation.Core where
...
-- * EMSAPIDocumentationConfig

-- | 
data EMSAPIDocumentationConfig = EMSAPIDocumentationConfig
...
-- | display the config
instance P.Show EMSAPIDocumentationConfig where
  show c =
    T.printf
...
-- | constructs a default EMSAPIDocumentationConfig
--
-- configHost:
--
-- @http://localhost:8080@
...
-- configUserAgent:
--
-- @"ems-api-documentation/0.1.0.0"@
--
newConfig :: IO EMSAPIDocumentationConfig
newConfig = do
    logCxt <- initLogContext
    return $ EMSAPIDocumentationConfig
        { configHost = "http://localhost:8080"
        , configUserAgent = "ems-api-documentation/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => EMSAPIDocumentationConfig -> auth -> EMSAPIDocumentationConfig
addAuthMethod config@EMSAPIDocumentationConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: EMSAPIDocumentationConfig -> IO EMSAPIDocumentationConfig
...
withStderrLogging :: EMSAPIDocumentationConfig -> IO EMSAPIDocumentationConfig
...
withNoLogging :: EMSAPIDocumentationConfig -> EMSAPIDocumentationConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * EMSAPIDocumentationRequest
...
data EMSAPIDocumentationRequest req contentType res accept = EMSAPIDocumentationRequest
  { rMethod  :: NH.Method   -- ^ Method of EMSAPIDocumentationRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of EMSAPIDocumentationRequest
  , rParams   :: Params -- ^ params of EMSAPIDocumentationRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (EMSAPIDocumentationRequest req contentType res accept) NH.Method
rMethodL f EMSAPIDocumentationRequest{..} = (\rMethod -> EMSAPIDocumentationRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (EMSAPIDocumentationRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f EMSAPIDocumentationRequest{..} = (\rUrlPath -> EMSAPIDocumentationRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (EMSAPIDocumentationRequest req contentType res accept) Params
rParamsL f EMSAPIDocumentationRequest{..} = (\rParams -> EMSAPIDocumentationRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (EMSAPIDocumentationRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f EMSAPIDocumentationRequest{..} = (\rAuthTypes -> EMSAPIDocumentationRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => EMSAPIDocumentationRequest req contentType res accept -> param -> EMSAPIDocumentationRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: EMSAPIDocumentationRequest req contentType res accept -> param -> EMSAPIDocumentationRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: EMSAPIDocumentationRequest req contentType res accept -> param -> EMSAPIDocumentationRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** EMSAPIDocumentationRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> EMSAPIDocumentationRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = EMSAPIDocumentationRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: EMSAPIDocumentationRequest req contentType res accept -> [NH.Header] -> EMSAPIDocumentationRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: EMSAPIDocumentationRequest req contentType res accept -> [NH.HeaderName] -> EMSAPIDocumentationRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => EMSAPIDocumentationRequest req contentType res accept -> EMSAPIDocumentationRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => EMSAPIDocumentationRequest req contentType res accept -> EMSAPIDocumentationRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: EMSAPIDocumentationRequest req contentType res accept -> [NH.QueryItem] -> EMSAPIDocumentationRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: EMSAPIDocumentationRequest req contentType res accept -> WH.Form -> EMSAPIDocumentationRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: EMSAPIDocumentationRequest req contentType res accept -> NH.Part -> EMSAPIDocumentationRequest req contentType res accept
...
_setBodyBS :: EMSAPIDocumentationRequest req contentType res accept -> B.ByteString -> EMSAPIDocumentationRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: EMSAPIDocumentationRequest req contentType res accept -> BL.ByteString -> EMSAPIDocumentationRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => EMSAPIDocumentationRequest req contentType res accept -> P.Proxy authMethod -> EMSAPIDocumentationRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: EMSAPIDocumentationConfig
    -> a
    -> EMSAPIDocumentationRequest req contentType res accept
    -> IO (EMSAPIDocumentationRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> EMSAPIDocumentationConfig
  -> IO (EMSAPIDocumentationRequest req contentType res accept)
_applyAuthMethods req config@(EMSAPIDocumentationConfig {configAuthMethods = as}) =
  foldlM go req as
  where
