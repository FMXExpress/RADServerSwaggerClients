## Swagger Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `EMS API Documentation` 

The library in `lib` provides auto-generated-from-Swagger [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the EMS API Documentation API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | EMSAPIDocumentation                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | ems-api-documentation                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | EMSAPIDocumentationConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | EMSAPIDocumentationRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| EMSAPIDocumentation.Client    | use the "dispatch" functions to send requests       |
| EMSAPIDocumentation.Core      | core funcions, config and request types             |
| EMSAPIDocumentation.API       | construct api requests                              |
| EMSAPIDocumentation.Model     | describes api models                                |
| EMSAPIDocumentation.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| EMSAPIDocumentation.ModelLens | lenses for model fields                             |
| EMSAPIDocumentation.Logging   | logging functions and utils                         |
