...
SWG_metaEdgeModuleObject::SWG_metaEdgeModuleObject(QString json) {
    init();
    this->fromJson(json);
}

SWG_metaEdgeModuleObject::SWG_metaEdgeModuleObject() {
    init();
}
...
void
SWG_metaEdgeModuleObject::cleanup() {
    if(creator != nullptr) { 
        delete creator;
    }
    if(created != nullptr) { 
...
SWG_metaEdgeModuleObject::fromJson(QString json) {
...
void
SWG_metaEdgeModuleObject::fromJsonObject(QJsonObject pJson) {
...
QString
SWG_metaEdgeModuleObject::asJson ()
{
...
QJsonObject
SWG_metaEdgeModuleObject::asJsonObject() {
    QJsonObject obj;
...
QString*
SWG_metaEdgeModuleObject::getCreator() {
    return creator;
}
void
SWG_metaEdgeModuleObject::setCreator(QString* creator) {
    this->creator = creator;
    this->m_creator_isSet = true;
}

QString*
SWG_metaEdgeModuleObject::getCreated() {
    return created;
}
void
SWG_metaEdgeModuleObject::setCreated(QString* created) {
    this->created = created;
    this->m_created_isSet = true;
}

QString*
SWG_metaEdgeModuleObject::getUpdated() {
    return updated;
}
void
SWG_metaEdgeModuleObject::setUpdated(QString* updated) {
...
bool
SWG_metaEdgeModuleObject::isSet(){
