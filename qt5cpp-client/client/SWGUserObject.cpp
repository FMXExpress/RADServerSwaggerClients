...
SWGUserObject::SWGUserObject(QString json) {
    init();
    this->fromJson(json);
}

SWGUserObject::SWGUserObject() {
    init();
}
...
SWGUserObject*
SWGUserObject::fromJson(QString json) {
...
void
SWGUserObject::fromJsonObject(QJsonObject pJson) {
...
void
SWGUserObject::setId(QString* id) {
    this->id = id;
    this->m_id_isSet = true;
}

QString*
SWGUserObject::getUsername() {
    return username;
}
void
SWGUserObject::setUsername(QString* username) {
    this->username = username;
    this->m_username_isSet = true;
}

SWG_metaObject*
SWGUserObject::getMeta() {
    return _meta;
}
void
SWGUserObject::setMeta(SWG_metaObject* _meta) {
    this->_meta = _meta;
