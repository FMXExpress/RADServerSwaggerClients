...
SWGFieldObject::SWGFieldObject(QString json) {
    init();
    this->fromJson(json);
}

SWGFieldObject::SWGFieldObject() {
    init();
}
...
SWGFieldObject*
SWGFieldObject::fromJson(QString json) {
...
void
SWGFieldObject::fromJsonObject(QJsonObject pJson) {
...
QString*
SWGFieldObject::getName() {
    return name;
}
void
SWGFieldObject::setName(QString* name) {
    this->name = name;
    this->m_name_isSet = true;
}

QList<SWGFieldObject_fields*>*
SWGFieldObject::getFields() {
    return fields;
}
void
SWGFieldObject::setFields(QList<SWGFieldObject_fields*>* fields) {
    this->fields = fields;
    this->m_fields_isSet = true;
}

bool
SWGFieldObject::isCustom() {
    return custom;
}
void
SWGFieldObject::setCustom(bool custom) {
    this->custom = custom;
