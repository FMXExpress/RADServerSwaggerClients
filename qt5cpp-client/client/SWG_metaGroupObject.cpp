...
SWG_metaGroupObject::SWG_metaGroupObject(QString json) {
    init();
    this->fromJson(json);
}

SWG_metaGroupObject::SWG_metaGroupObject() {
    init();
}
...
SWG_metaGroupObject*
SWG_metaGroupObject::fromJson(QString json) {
...
void
SWG_metaGroupObject::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
SWG_metaGroupObject::asJsonObject() {
    QJsonObject obj;
...
QString*
SWG_metaGroupObject::getCreator() {
    return creator;
}
void
SWG_metaGroupObject::setCreator(QString* creator) {
    this->creator = creator;
    this->m_creator_isSet = true;
}

QString*
SWG_metaGroupObject::getCreated() {
    return created;
}
void
SWG_metaGroupObject::setCreated(QString* created) {
    this->created = created;
    this->m_created_isSet = true;
}

QString*
SWG_metaGroupObject::getUpdated() {
    return updated;
}
void
SWG_metaGroupObject::setUpdated(QString* updated) {
