...
SWG_metaInstallationObject::SWG_metaInstallationObject(QString json) {
    init();
    this->fromJson(json);
}

SWG_metaInstallationObject::SWG_metaInstallationObject() {
    init();
}
...
void
SWG_metaInstallationObject::init() {
    creator = new QString("");
...
void
SWG_metaInstallationObject::cleanup() {
    if(creator != nullptr) { 
        delete creator;
    }
    if(created != nullptr) { 
...
SWG_metaInstallationObject::fromJson(QString json) {
...
void
SWG_metaInstallationObject::fromJsonObject(QJsonObject pJson) {
...
QString
SWG_metaInstallationObject::asJson ()
{
...
QJsonObject
SWG_metaInstallationObject::asJsonObject() {
    QJsonObject obj;
...
QString*
SWG_metaInstallationObject::getCreator() {
    return creator;
}
void
SWG_metaInstallationObject::setCreator(QString* creator) {
    this->creator = creator;
    this->m_creator_isSet = true;
}

QString*
SWG_metaInstallationObject::getCreated() {
    return created;
}
void
SWG_metaInstallationObject::setCreated(QString* created) {
    this->created = created;
    this->m_created_isSet = true;
}

QString*
SWG_metaInstallationObject::getUpdated() {
    return updated;
}
void
SWG_metaInstallationObject::setUpdated(QString* updated) {
...
bool
SWG_metaInstallationObject::isSet(){
